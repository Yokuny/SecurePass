...
const MyProduct = () => {
  return (
    <div className="py-10">
      <Card className="flex flex-col-reverse md:flex-row items-center justify-center md:py-16 p-4 md:gap-8 gap-4">
        <Card isFooterBlurred radius="lg" className="border-none">
          ...
          <CardFooter className="justify-between before:bg-white/10 border-white/20 border-1 overflow-hidden py-2 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10">
            ...
            <Button className="text-tiny text-white" variant="shadow" color="success" radius="lg">
              Entrar
            </Button>
          </CardFooter>
        </Card>
